...
<head>
<title>all recommended documents</title>
    ...
    <div class="content_resize">
      ...
      <!--  <div class="article_vert"><img src="images/img1.jpg" width="287" height="97" alt="" />
        ...
        <div class="article_vert"><img src="images/img2.jpg" width="287" height="97" alt="" />
		 ...
		 <h2 class="style7">All Recommended Documents List </h2>
	     <div class="area">
		...
		try
		{
			...
			int i=0,m=0;
			String sql="select distinct doc_id from recommends";
			...
			while(rs.next())
			{
				...
				<form action="a_view_rcmd_doc_details.jsp?id=<%=i%>" method="post">
