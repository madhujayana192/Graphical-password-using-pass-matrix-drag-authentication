...
<title>select click points</title></HEAD>
 <BODY>
 <%String uname=request.getParameter("uname"); 
 %>
 <form name="portion" method="post" action="u_addclickpoints.jsp?uname=<%=uname%>">
 <table width="1192">
 <tr>
   <th height="58" colspan="3"><span class="style2">Select Your Graphical Password on Image Portion</span></th>
 </tr>
 <tr>
