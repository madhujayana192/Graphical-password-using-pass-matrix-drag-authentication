...
<head>
<title>recommended Documents Details</title>
      ...
      <!--  <div class="article_vert"><img src="images/img1.jpg" width="287" height="97" alt="" />
		...
		{	
			...
			if(rs.next())
			{
				...
				<tr>
					<th width="168" height="36" align="left" valign="middle"><span class="style14 style19">Comments : </span></th>
				...
				while(rs1.next())
				{
				  ...
				  <span class="style16"> <%=name%>: </span><span class="style18"> <%=cmt%></span>&nbsp;&nbsp; <%=dt%><br />
				<%
				}
				%>				</td>
				</tr>
        ...
        <div class="style3"> <p align="right" class="style11"><a href="allrecommended_docs.jsp" class="style12">Back</a></p></div>
