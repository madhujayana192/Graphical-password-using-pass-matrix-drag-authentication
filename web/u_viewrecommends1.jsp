...
.style19 {color: #6666FF; font-size: 12px; }
-->
</style>
      ...
      <!--  <div class="article_vert"><img src="images/img1.jpg" width="287" height="97" alt="" />
		...
		try
		{
			...
			if(rs.next())
			{
				...
				%>
				<form action="u_updatedocrank.jsp?id=<%=i%>&type=<%="recommends"%>" method="post" id="download"></form>
				<form action="u_comments.jsp?id=<%=i%>&type=<%="recommends"%>" method="post" id="comments"></form>
				<tr>
				...
				<tr>
					<th width="168" height="36" align="left" valign="middle"><span class="style14">Comments : </span></th>
					<td align="left" valign="middle">
				<%
				String sql1="select * from comments where doc_id='"+id+"'";
				...
				while(rs1.next())
				{
				  ...
				  <span class="style17"> <%=name%>: </span><span class="style19"> <%=cmt%></span>&nbsp;&nbsp; <%=dt%><br />
				<%
				}
				%>
				</td>
				...
				<tr>
				  <td colspan="2" align="center" valign="middle"> <button onClick="saveTextAsFile()" type="submit" form="download">Download</button></td>
				</tr>
        ...
        <div class="style3">
		<p align="right" class="style11"><a href="u_viewrecommends.jsp" class="style12 style10">Back</a></p>
		</div>
